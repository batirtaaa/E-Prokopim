@extends('layouts.app')
@section('title', 'Tambah Analisis Isu & Media — E-PROKOPIM')
...
<div class="page-header-row">
    <div class="page-header-left">
        <h1>Tambah Analisis Isu &amp; Media</h1>
        <p>Lengkapi formulir di bawah ini untuk mencatat analisis isu, pemetaan sentimen, serta rekomendasi kebijakan dan publikasi.</p>
    </div>
</div>
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" name="judul" value="{{ old('judul') }}" placeholder="Contoh: Penertiban Pedagang Kaki Lima di Kawasan Alun-Alun" required autofocus>
            ...
            <div class="form-row-2">
                <div class="form-group">
                    ...
                    <input type="date" class="form-input" name="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="sumber_isu" value="{{ old('sumber_isu') }}" placeholder="Contoh: Instagram @humas_bandung / Detik" required>
            ...
            <div class="form-group">
                ...
                <div class="pill-radio-group">
                    <label class="pill-radio-label {{ old('jenis_media', 'Sosial') === 'Sosial' ? 'active-sosial' : '' }}" onclick="selectMedia(this, 'Sosial')">
                        <input type="radio" name="jenis_media" value="Sosial" {{ old('jenis_media', 'Sosial') === 'Sosial' ? 'checked' : '' }} required>
                    ...
                    <label class="pill-radio-label {{ old('jenis_media') === 'Online' ? 'active-online' : '' }}" onclick="selectMedia(this, 'Online')">
                        <input type="radio" name="jenis_media" value="Online" {{ old('jenis_media') === 'Online' ? 'checked' : '' }}>
                    ...
                    <label class="pill-radio-label {{ old('jenis_media') === 'Cetak' ? 'active-cetak' : '' }}" onclick="selectMedia(this, 'Cetak')">
                        <input type="radio" name="jenis_media" value="Cetak" {{ old('jenis_media') === 'Cetak' ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input list="leadingSectorsList" class="form-input" name="leading_sector" value="{{ old('leading_sector') }}" placeholder="Pilih atau ketik nama dinas/bagian..." required>
            ...
            <div class="form-group">
                ...
                <div class="sentiment-radio-group">
                    <label class="sentiment-label {{ old('sentimen') === 'Positif' ? 'active-positif' : '' }}" onclick="selectSentimen(this, 'Positif')">
                        <input type="radio" name="sentimen" value="Positif" {{ old('sentimen') === 'Positif' ? 'checked' : '' }} required>
                        Positif
                    </label>
                    <label class="sentiment-label {{ old('sentimen', 'Netral') === 'Netral' ? 'active-netral' : '' }}" onclick="selectSentimen(this, 'Netral')">
                        <input type="radio" name="sentimen" value="Netral" {{ old('sentimen', 'Netral') === 'Netral' ? 'checked' : '' }}>
                        Netral
                    </label>
                    <label class="sentiment-label {{ old('sentimen') === 'Negatif' ? 'active-negatif' : '' }}" onclick="selectSentimen(this, 'Negatif')">
                        <input type="radio" name="sentimen" value="Negatif" {{ old('sentimen') === 'Negatif' ? 'checked' : '' }}>
                        Negatif
                    </label>
                </div>
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <div class="form-group">
                ...
                <textarea class="form-textarea" name="analisis" style="min-height:95px" placeholder="Jelaskan deskripsi telaahan, fakta di lapangan, dinamika percakapan publik, dan potensi implikasi terhadap citra pimpinan/pemerintah kota..." required>{{ old('analisis') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-textarea" name="rekomendasi_kebijakan" style="min-height:85px" placeholder="Tuliskan rekomendasi langkah kebijakan teknis untuk Pimpinan dan OPD terkait..." required>{{ old('rekomendasi_kebijakan') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-textarea" name="rekomendasi_publikasi" style="min-height:85px" placeholder="Tuliskan strategi publikasi, penyiapan rilis klarifikasi, infografis fakta, atau narasi komunikasi publik..." required>{{ old('rekomendasi_publikasi') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input type="url" class="form-input" name="link_sumber" value="{{ old('link_sumber') }}" placeholder="https://instagram.com/p/... atau https://news.detik.com/...">
...
<div class="form-footer-card">
    <a href="{{ route('analisis.index') }}" class="btn-cancel">Batal</a>
