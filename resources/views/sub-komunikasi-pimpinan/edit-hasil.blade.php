@extends('layouts.app')
@section('title', 'Edit Hasil Sambutan — E-PROKOPIM')
...
<div class="page-header-row">
    <div class="page-header-left">
        <h1>Edit Hasil Sambutan</h1>
        <p>Perbarui informasi draf atau hasil naskah sambutan pimpinan.</p>
    </div>
</div>
...
@csrf
@method('PUT')
<input type="hidden" name="status_urgensi" value="{{ $sambutan->status_urgensi ?? 'biasa' }}">
    ...
    <div class="form-card" style="display:flex;flex-direction:column">
        ...
        <div class="upload-wrap">
            ...
            <label class="upload-area" for="input-dokumen2" id="upload-label2">
                <input type="file" id="input-dokumen2" name="dokumen" accept=".pdf,.jpg,.jpeg,.png" onchange="handleFile2(this)">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:36px;height:36px;color:#2563eb"><path stroke-linecap="round" stroke-linejoin="round" d="M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z"/></svg>
                <div class="upload-main" id="upload-main-text2">Drag & Drop file di sini untuk mengganti</div>
...
function handleFile2(input) {
    if (input.files && input.files[0]) {
        ...
        document.getElementById('upload-sub-text2').textContent = 'File baru siap diunggah';
        document.getElementById('upload-label2').style.borderColor = '#2563eb';
        document.getElementById('upload-label2').style.background = '#eff6ff';
    }
}
</script>
@endpush
