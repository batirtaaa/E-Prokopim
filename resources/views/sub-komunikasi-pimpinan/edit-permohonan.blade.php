        ...
        <div class="form-card-body">
            ...
            <div class="form-row-2" style="margin-bottom:18px">
                ...
                <div class="form-group" style="margin-bottom:0">
                    ...
                    <input type="time" class="form-input" name="waktu_acara" value="{{ old('waktu_acara', $sambutan->waktu_acara ?? '') }}" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-select" name="tujuan" id="selecttujuan" onchange="toggleTujuanCustom(this.value)" required>
                    <option value="" disabled {{ empty($selectedTujuan) ? 'selected' : '' }}>Pilih pimpinan tujuan...</option>
                    ...
                    <option value="Sekretaris Daerah (B3)" {{ $selectedTujuan === 'Sekretaris Daerah (B3)' ? 'selected' : '' }}>Sekretaris Daerah (Sekda / B3)</option>
        ...
        <div class="form-row-2" style="margin-bottom:18px">
            ...
            <div class="form-group" style="margin-bottom:0">
                ...
                <select class="form-select" name="status" id="input-status">
                    <option value="" disabled {{ empty($sambutan->status) ? 'selected' : '' }}> Status Progres</option>
                    <option value="proses" {{ old('status', $sambutan->status) === 'proses' || old('status', $sambutan->status) === 'diproses' ? 'selected' : '' }}>proses</option>
