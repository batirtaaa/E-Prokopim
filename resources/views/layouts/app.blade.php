...
<head>
    ...
    <style>
        ...
        .sidebar-nav-group { margin-bottom: 1px; }

        /* Group header: same look as sidebar-nav-link */
        ...
        .sidebar-nav-group-children.open { display: block; }
        .sidebar-nav-group-children .sidebar-nav-link {
            font-size: 13px;
            padding: 7px 10px;
        }
        /* Section label */
...
<div class="app-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="sidebar-nav-group">
                <div class="sidebar-nav-group-header {{ request()->routeIs('sub-protokol.*') ? 'active open' : '' }}" onclick="toggleNavGroup(this)">
                    <svg class="main-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /></svg>
                    Protokol Pimpinan
                    <svg class="chevron" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" /></svg>
                </div>
                <div class="sidebar-nav-group-children {{ request()->routeIs('sub-protokol.*') ? 'open' : '' }}">
                    <a href="{{ route('sub-protokol.index') }}" class="sidebar-nav-link {{ request()->routeIs('sub-protokol.*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:14px;height:14px"><circle cx="12" cy="12" r="2" fill="currentColor"/></svg>
                        Sub Protokol
                    </a>
                </div>
        ...
        <header class="topbar">
            <div class="topbar-left">
                @hasSection('topbar-title')
                    <h1 class="topbar-title">E-PROKOPIM</h1>
                @else
                    <h1 class="topbar-title">E-PROKOPIM</h1>
                @endif
                ...
                <div class="topbar-search">
                    ...
                    <input type="text" placeholder="Cari..." id="topbar-search-input">
                </div>
            </div>
            ...
            <div class="topbar-right">
                ...
                <div class="dropdown-wrapper">
                    <div class="topbar-user" data-dropdown="#user-menu">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:14px;height:14px;color:#6b7280"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" /></svg>
                    </div>
                    <div class="dropdown-menu" id="user-menu">
                        <a href="{{ route('profil-admin.index') }}" class="dropdown-item">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                            Profil Saya
                        </a>
