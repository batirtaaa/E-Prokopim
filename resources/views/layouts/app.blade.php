...
<head>
    ...
    <title>@yield('title', 'Dashboard') — SIKOPIM Kota Bandung</title>
...
<div class="app-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('kegiatan.index') }}" class="sidebar-nav-link {{ request()->routeIs('kegiatan.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('notulensi.index') }}" class="sidebar-nav-link {{ request()->routeIs('notulensi.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /></svg>
                Notulensi
            </a>
            <a href="{{ route('arahan.index') }}" class="sidebar-nav-link {{ request()->routeIs('arahan.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('dokumentasi.index') }}" class="sidebar-nav-link {{ request()->routeIs('dokumentasi.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" /></svg>
                Dokumentasi
            </a>
            <a href="{{ route('daftar-hadir.index') }}" class="sidebar-nav-link {{ request()->routeIs('daftar-hadir.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" /></svg>
                Daftar Hadir
            </a>
            <a href="{{ route('laporan.index') }}" class="sidebar-nav-link {{ request()->routeIs('laporan.*') ? 'active' : '' }}">
            ...
            <a href="#" class="sidebar-nav-link" target="_blank">
                ...
                Media Monitoring
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ext-icon"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" /></svg>
            </a>
            <a href="#" class="sidebar-nav-link" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M20.7 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5m6 4.125l2.25 2.25m0 0l2.25 2.25M12 13.875l2.25-2.25M12 13.875l-2.25-2.25M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" /></svg>
                Asset Monitoring
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ext-icon"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" /></svg>
            </a>
            <a href="#" class="sidebar-nav-link" target="_blank">
        ...
        <header class="topbar">
            <div class="topbar-left">
                @hasSection('topbar-title')
                    <h1 class="topbar-title">@yield('topbar-title')</h1>
                @else
                    <h1 class="topbar-title">SIKOPIM</h1>
                @endif
                ...
                @hasSection('topbar-search')
                    <div class="topbar-search">
                        ...
                        <input type="text" placeholder="Cari data..." id="topbar-search-input">
                    </div>
                @endif
            </div>
            ...
            <div class="topbar-right">
                ...
                <button class="topbar-btn" title="Kalender">
                ...
                <div class="dropdown-wrapper">
                    <div class="topbar-user" data-dropdown="#user-menu">
                        <div class="topbar-user-info">
                            ...
                            <div class="topbar-user-role">{{ auth()->user()->getRoleLabel() }}</div>
                        </div>
